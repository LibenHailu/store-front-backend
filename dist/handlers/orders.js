...
var order_routes = function (app) {
    ...
    app.get("orders/me", auth_1.auth, showByUserID);
    app.post("/orders", auth_1.auth, create);
    app["delete"]("/orders/:id", auth_1.auth, destory);
    app.put("/orders/:id", auth_1.auth, update);
    app.post("/orders/:id/products", auth_1.auth, addProduct);
};
