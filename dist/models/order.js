...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not find orders of user ".concat(id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add new order for user ".concat(o.user_id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.update = function (id, o) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, updatedOrder, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "UPDATE orders SET staus = $1, user_id = $2 WHERE id = $3 RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [o.status, o.user_id, id])];
                    case 2:
                        result = _a.sent();
    ...
    OrderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, order, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
